...
function Figure_SleepScoring_Accelero_Ferret(coeff_display, foldername)
...
for i=2:3
    ...
    try
        load('SleepScoring_Accelero.mat','Wake','SWSEpoch','REMEpoch','ISEpoch')
        WakeAcc = Wake;
        SWSEpochAcc = SWSEpoch;
        REMEpochAcc = REMEpoch;
        ISEpochAcc = ISEpoch;
    ...
    try
        ...
        PlotPerAsLine(ISEpochAcc, LineHeight, Colors.IS, 'timescaling', 3600e4, 'linewidth',10);
        PlotPerAsLine(TotalNoiseEpoch, LineHeight, Colors.Noise, 'timescaling', 3600e4, 'linewidth',10);
    catch
        load('StateEpochSB')
        PlotPerAsLine(REMEpochAcc, LineHeight, Colors.REM, 'timescaling', 3600e4, 'linewidth',10);
        PlotPerAsLine(SWSEpochAcc, LineHeight, Colors.SWS, 'timescaling', 3600e4, 'linewidth',10);
